...
function tickerRefresh() {
	url2 = "http://www.ecp-liveticker.de/script/getTickerAction.php?mannschaftID=4";
	$.ajax({
		url : url2,
		dataType : 'jsonp',
...
function getLetzteMeldung() {
	var url = "http://www.ecp-liveticker.de/script/getBegegnung.php" + "?spielID=" + spielID;
	$.ajax({
		url : url,
		dataType : 'jsonp',
		jsonp : 'jsonp_callback',
...
function getSpieldaten(url) {
	$.ajax({
		...
		success : function(data) {
			...
			getMannschaftUrl = "http://www.ecp-liveticker.de/script/getMannschaft.php?mannschaftID=" + mannschaftID;
...
function init() {
	...
	getSpieldatenUrl = "http://www.ecp-liveticker.de/script/getBegegnung.php" + "?spielID=" + spielID;
