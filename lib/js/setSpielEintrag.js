...
function init() {
	getMannschaftenUrl = "http://ecp-liveticker.de/script/getData.php?action=mannschaften";
	getMannschaften(getMannschaftenUrl);
	getGegnerUrl = "http://ecp-liveticker.de/script/getData.php?action=vereine";
...
function absenden(final) {
	...
	$.post("http://edit.ecp-liveticker.de/script/writeSpiel.php", {
